...
<section class="terms-and-conditions" style="margin-top: 300px;">
    <div class="custom-container">
        ...
        <ul>
            <li><strong>Produk:</strong> Sewa dan Rental Mobil yang ditawarkan di website kami.</li>
            <li><strong>Pengguna:</strong> Setiap orang yang mengakses dan menggunakan website kami.</li>
        </ul>

        <h5>Penggunaan Layanan</h5>
        <p>Anda setuju untuk menggunakan layanan kami hanya untuk tujuan yang sah dan tidak melanggar hukum. Anda tidak diperbolehkan untuk:</p>
        <ul>
            <li>Melakukan penipuan atau aktivitas ilegal.</li>
            <li>Menyalin, memodifikasi, atau mendistribusikan konten kami tanpa izin.</li>
        </ul>
