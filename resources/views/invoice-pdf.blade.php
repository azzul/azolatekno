...
<body>
  ...
  @if(!empty($dp) && $dp > 0)
  <tr>
    <td colspan="4" style="text-align:right">DP / Pembayaran Awal</td>
    <td style="text-align:right">- {{ number_format($dp, 2) }}</td>
  </tr>
  @endif

  <tr>
    <td colspan="4" style="text-align:right"><strong>Sisa Tagihan</strong></td>
    <td style="text-align:right"><strong>{{ number_format($sisa, 2) }}</strong></td>
  </tr>
</tfoot>
  </table>
  
<div style="position: fixed; top:40%; left:20%; opacity:0.02; text-align:center; transform:rotate(-30deg);">
    <div style="font-size:14px; margin-bottom:5px;">Generated by Invoice Generator</div>
    <div style="font-size:50px; font-weight:bold;">AZOLATEKNO</div>
</div>
    @if(!empty($data['rekening']))
        <p class="thanks">Silahkan Transfer ke Rekening {{ $data['rekening'] }}</p>
    @endif
