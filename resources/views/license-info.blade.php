...
<section class="privacy-policy"  style="margin-top: 300px;">
    <div class="custom-container">
        ...
        <h3>Hak Cipta</h3>
        <p>© 2025 Azolatekno. Semua hak cipta gambar di situs ini dilindungi dan tidak boleh digunakan tanpa izin eksplisit dari Azolatekno.</p>

        <h3>Informasi Lisensi Lainnya</h3>
        <p>Jika Anda tertarik untuk menggunakan gambar atau konten lain di situs ini untuk keperluan komersial atau lainnya, silakan hubungi kami melalui <a href="mailto:info@azolatekno.id">info@azolatekno.id</a> untuk informasi lebih lanjut mengenai lisensi dan izin penggunaan.</p>
    </div>
</section>
@endsection