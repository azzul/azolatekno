...
<head>
   ...
   <link rel="alternate" href="{{ request()->url() }}" hreflang="id" />
    ...
    <link rel="preload" as="style" href="{{ asset('css/layout/app-new-tools.css') }}?v={{ filemtime(public_path('css/layout/app-new-tools.css')) }}" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('css/layout/app-new-tools.css') }}"></noscript>
