...
<head>
   ...
   <link rel="alternate" href="{{ request()->url() }}" hreflang="id" />
    ...
    <link rel="preload" as="style" href="{{ asset('css/layout/app-detail.css') }}?v={{ filemtime(public_path('css/layout/app-detail.css')) }}" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('css/layout/app-detail.css') }}"></noscript>
   <!-- Preload font Poppins (400, 600, 700) -->
