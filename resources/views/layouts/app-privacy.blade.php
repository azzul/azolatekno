...
<head>
   ...
   <link rel="alternate" href="{{ request()->url() }}" hreflang="id" />
    ...
    <link rel="preload" as="style" href="{{ asset('css/layout/app-privacy.css') }}?v={{ filemtime(public_path('css/layout/app-privacy.css')) }}" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('css/layout/app-privacy.css') }}"></noscript>
   <!-- Preload font Poppins (400, 600, 700) -->
     <link rel="preload" href="{{ asset('css/main.min.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('css/main.min.css') }}?v={{ time() }}"></noscript>
    <link rel="preload" href="{{ asset('css/secondary.min.css')}}" as="style" onload="this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('css/secondary.min.css') }}?v={{ time() }}"></noscript>
